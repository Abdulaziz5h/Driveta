  ...
  <b-container>
    <b-row>
      <b-col cols="12" class="d-flex mb-2">
        <a-back :path="'/admin/drivers/' + ownerId + '/invoices'" class="mr-2" />
    ...
    <b-card no-body class="mb-3">
      ...
      <b-card-body class="pb-0">
        <b-row>
          <b-col cols="12" md="6">
            <a-input-text :label="$t('owner.form.name.label')" readonly name="name" :value="userName" />
          </b-col>
          <b-col cols="12" md="6">
          ...
          <b-col cols="12" md="6">
            <a-input-text label="الكلفة الكلية المستحقة للمالك  عن جميع التوصيلات" readonly name="org total" :value="total + ' ' + $t('sp')" />
          </b-col>
          <b-col cols="12" md="6">
            <a-input-text label="الكلفة الكلية للفاتورة حسب التوصيلات المختارة" readonly name="total" :value="getTotalInvoiceCost() + ' ' + $t('sp')" />
          </b-col>
          <b-col cols="12" md="6">
            <a-input-text label="مرابح المالك من التوصيلات المختارة" readonly name="total"
        ...
        <ul class="list-group">
          <li class="list-group-item p-0 mb-3" v-for="(delivery, index) of deliveries" :key="index">
            <b-card-header class="p-2 d-flex justify-content-between align-items-center">
              <h6 class="m-0 title">
                <strong>اسم السائق</strong>: {{ delivery.driverName }}
              </h6>
              <span v-if="!isEdit">
            ...
            <div class="p-2 pb-0 pt-3">
              <b-row>
                <b-col cols="12" md="6">
                  <div class="mb-2">
                    <strong>اسم الزبون</strong>: {{ delivery.customerName }} <br />
                  </div>
                  <div class="mb-2">
                  ...
                  <div class="mb-2">
                    <strong>نسبة المالك</strong>: {{ delivery.rate + '%' }}
                  </div>
                </b-col>
                <b-col cols="12" md="6">
                  <div class="mb-2">
                  ...
                  <div class="mb-2">
                    <strong>القيمة المستحقة للمالك</strong>: {{ delivery.price *
    ...
    submit() {
      this.addDriverOwnerInvoice({
        dto: {
          ...
          type: this.dto.type,
          userId: this.ownerId,
          total: this.getTotalDriverBenfits(),
