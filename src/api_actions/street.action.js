...
const END_POINT = "street/";
export const getByFilter = (payload = {}, cb) => {
  return api.post(formatApiEndPoint(END_POINT, "GetByFilter"), payload, cb);
};
...
export const deleteStreet = (id, cb) => {
